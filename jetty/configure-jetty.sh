...
wget https://raw.github.com/fabienfoerster/yourcast-monitoring/master/jetty/config/jetty-jmx.xml > /dev/null 2> /dev/null
...
if [ "$?" = "0" ]; then echo "OK"; else echo "FAILURE";exit 1; fi
